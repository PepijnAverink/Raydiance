...
namespace Raydiance
{
	namespace Graphics
	{
		inline DXGI_FORMAT ResolveDX12ResourceFormat(RHI_ResourceFormat _format)
		{
			...
			case RHI_ResourceFormat::RHI_RESOURCE_FORMAT_B8G8R8A8_SRGB: // RHI_RESOURCE_FORMAT_B8G8R8A8_UNORM_SRGB
			...
			case RHI_ResourceFormat::RHI_RESOURCE_FORMAT_R32G32_SFLOAT: // RHI_RESOURCE_FORMAT_R32G32_FLOAT
			...
			case RHI_ResourceFormat::RHI_RESOURCE_FORMAT_R32G32B32_SFLOAT: // RHI_RESOURCE_FORMAT_R32G32B32_FLOAT
