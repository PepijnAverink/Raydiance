...
namespace Raydiance
{
	namespace Graphics
	{
		enum RHI_ResourceFormat
		{
			...
			RHI_RESOURCE_FORMAT_B8G8R8A8_UNORM		= 0x02,
			RHI_RESOURCE_FORMAT_R32G32_SFLOAT		= 0x03,
			RHI_RESOURCE_FORMAT_R32G32B32_SFLOAT	= 0x04,
			RHI_RESOURCE_FORMAT_R16_UINT			= 0x05,
			RHI_RESOURCE_FORMAT_CUSTOM				= 0x06,
		};
